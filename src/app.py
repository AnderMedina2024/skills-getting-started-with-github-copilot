...
activities = {
    ...
    "Swim Club": {
        "description": "Swim training, relay practice, and aquatic fitness",
    ...
    "Art Workshop": {
        ...
        "max_participants": 15,
        "participants": ["lily@mergington.edu", "sophia@mergington.edu"]
    },
    "Drama Club": {
    ...
    "Science Club": {
        "description": "Conduct experiments, study current science topics, and prepare projects",
